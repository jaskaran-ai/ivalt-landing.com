...
import ivaltCompletesIam from "@/assets/images/solutions/ivalt-completes-iam.png";
...
export default function IvaltCompletesIam() {
  return (
    <FadeInOnScroll className="bg-white">
      <Container className="max-w-7xl">
        <SectionTitle
          title="Ivalt Completes IAM"
          description="Complete Identity and Access Management"
        />
        <div className="flex justify-center items-center my-4 mb-6">
          <Image
            src={ivaltCompletesIam}

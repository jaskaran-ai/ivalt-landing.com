...
export function RevolutionIdentity() {
    ...
    return (
        <section className="py-8 bg-slate-50">
            <h1 className="text-5xl text-center pb-14 text-primary font-bold">Revolutionizing Identity</h1>
                ...
                <div className="grid auto-rows-fr grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {features.map((item) => {
                        ...
                        return (
                            <Card
                                key={item.id}
                                className={`relative overflow-hidden bg-white rounded-2xl p-6 transition-all duration-200 hover:shadow-xl ${item.span || "col-span-1"}`}
                            >
